...
const Contact = () => {
    return (
        <div id="Contact" className="w-full pb-8 bg-zinc-100">
            <section className="px-8 md:px-16 py-20">
                ...
                <Div className="mb-10 relative">
                    <div className="flex text-center justify-center gap-2 md:gap-0 md:flex-col text-[20px] md:text-[45px] 2xl:text-[60px] leading-[20px] md:leading-[40px] 2xl:leading-[60px] font-oswald mb-10">
                        <h3 className="text-center text-2xl pt-8 text-zinc-800 font-display sm:text-6xl md:text-7xl mt-2 font-bold tracking-tight md:text-center">
                            LET'S TALK
                        </h3>
                    </div>
                    <div className="text-[16px] 2xl:text-[20px] leading-[24px] 2xl:leading-[32px] text-zinc-700 text-center max-w-[1200px] mx-auto">
